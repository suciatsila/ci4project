            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url("/update_jenis/" . $jenis['id_jenis']) ?>" class="needs-validation" novalidate="">
                                <div class="form-group">
                                    <label for="jenis">Jenis Pembayaran</label>
                                    <input id="nama_jenis" type="text" value="<?php echo $jenis['nama_jenis'] ?>" class="form-control" name="nama_jenis" tabindex="1" required autofocus>
