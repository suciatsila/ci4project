            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url("/insert_jenis") ?>" class="needs-validation" novalidate="">
                                <div class="form-group">
                                    <label for="email">Jenis Pembayaran</label>
                                    <input id="nama_jenis" type="nama_jenis" class="form-control" name="nama_jenis" tabindex="1" required autofocus>
                                </div>
