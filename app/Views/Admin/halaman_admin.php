            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="nav-link" href="<?= base_url("/dataPembayaran") ?>"><i class="fas fa-columns"></i> <span>Data Pembayaran</span></a>
                        </li>
                        <li><a class="nav-link" href="<?= base_url("/jenisPembayaran") ?>"><i class="far fa-square"></i> <span>Jenis Pembayaran</span></a></li>
                        <li class="nav-item dropdown">
                            <a href="<?= base_url("/tampilTagihan") ?>" class="nav-link"><i class="fas fa-th"></i> <span>Tagihan</span></a>
                        </li>
                        <li class="nav-item dropdown">
